...
CREATE TABLE "MEMBER" (
	...
	"MEMBER_STATUS"	VARCHAR2(2)	DEFAULT 'A'	NULL
);
...
COMMENT ON COLUMN "ADMIN"."ADMIN_ROLL" IS '관리자 등급';
...
CREATE TABLE "TODO" (
	"TODO_ID"	NUMBER		NULL,
	"REF_TODOLIST_ID"	NUMBER		NOT NULL,
	"REF_WORKS_MEMBER_NO"	NUMBER		NOT NULL,
	...
	"REF_TODO_STATUS_ID"	NUMBER		NULL
);

COMMENT ON COLUMN "TODO"."TODO_ID" IS 'ToDo ID';

COMMENT ON COLUMN "TODO"."REF_TODOLIST_ID" IS 'ToDo리스트 ID';
...
COMMENT ON COLUMN "TODO"."REF_TODO_STATUS_ID" IS 'ToDo 상태 ID';
...
COMMENT ON COLUMN "CHANNEL"."FIELD" IS '비공개 채널여부';
