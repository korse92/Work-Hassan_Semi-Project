                    ...
                    <div class="col-lg-12 text-center">
                        <div class="p-5 text-center">
                            <div class="text-center" >
                                <h1 class="h4 text-gray-900 mb-4 my-4">What are you going to do?</h1>
                            </div>
                            
                            <div class="my-4" ></div>
                            
                            <form class="user" 
                            	  action="<%=request.getContextPath() %>/todo/todoUpdate"
                            	  name="todoUpdateFrm"
                            	  method="post">
                                ...
                                <div class="row">
                                    <div class="col-lg-8" style="float: none; margin: 0 auto;">
                                        <input 
                                        	...
                                        	name="todoTitle" 
                                        	id="todoTitle_"
                                            value="<%= todo.getTodoTitle()%>" required>
                                            <br />
                                    </div>
                                    <br />
                                    <div class="col-lg-8" style="float: none; margin: 0 auto;">
                                        <textarea 
                                        	...
                                        	name="todoContent" 
                                        	id="todoContent_"
                                            placeholder="<%= todo.getTodoTitle()%>"><%= todo.getTodoContent()%></textarea>
                                            <br />
                                    </div>
                                    ...
                                    <div class="col-lg-8 my-2" style="float: none; margin: 0 auto;">
                                    		Start<br />
						   					<input 
						   						type="date" 
						   						class="form-control form-control-user" 
						   						name="todoStartDate" 
						   						id="todoStartDate_" 
						   						value="<%= todo.getTodoStartDate()%>" required><br />
                                    </div>
                                    ...
                                    <div class="col-lg-8 my-2" style="float: none; margin: 0 auto;">
                                    		End<br />
						   					<input 
						   						...
						   						name="todoEndDate" 
						   						id="todoEndDate_" 
						   						value="<%= todo.getTodoEndDate()%>" required><br />
                                    </div>
                                    <div class="my-4"></div>
                            	...
                            	<hr>
	                                <input type="submit" class="btn btn-primary btn-split center" value="수정" >
