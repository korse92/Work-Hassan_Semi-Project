    ...
    <div id="wrapper">
		...
		<div class="row-vh d-flex flex-row">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<%= request.getContextPath() %>index.jsp">
                ...
                <!-- 파비콘 i로 번개 모양 삽입되었음 -->
                    <img style="width:50px;" src="<%= request.getContextPath() %>/img/logo.png">
                </div>
                <div class="sidebar-brand-text mx-3">Work, hassan!</div>
            </a>
            ...
            <!-- Nav Item - 메뉴 - 인터페이스 관련 하위 메뉴 타이틀-->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Button/Cards</span>
                </a>
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom Components:</h6>
                        <a class="collapse-item" href="<%= request.getContextPath() %>buttons.jsp">Buttons</a>
                        <a class="collapse-item" href="<%= request.getContextPath() %>cards.jsp">Cards</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="utilities.jsp">Guide</a>
                    </div>
                </div>
            </li>
