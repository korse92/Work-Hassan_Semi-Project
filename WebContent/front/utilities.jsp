...
<%@ include file="header.jsp" %>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">All Utilities</h1>
                    <hr>
                    <h1 class="h3 mb-1 text-gray-800">Color Guide 컬러</h1>
                    <p class="mb-4">각종 텍스트 및 백그라운드, 글꼴 크기 등의 style 클래스명입니다.</p>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Border All 보더</h1>
                    <p class="mb-4">보더 옵션 스타일 클래스명입니다.</p>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Animation All 애니메이션</h1>
                    <p class="mb-4">드롭다운 메뉴를 펼칠 때 등 애니메이션 관련 클래스명입니다.</p>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card position-relative">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="mb-0 small">CSS 트랜스폼 속성에 애니메이션이 적용된 것, 기존 변환이 재정의됩니다.</p>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card position-relative">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="mb-0 small">CSS 불투명도(opacity)속성에 애니메이션이 적용된 것, 기존 불투명도를 재정의합니다. </p>
                                </div>
                            </div>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Other All</h1>
                    <p class="mb-4">회전이나 오버플로우 히든, 프로그래스 바 등의 클래스명입니다.</p>
